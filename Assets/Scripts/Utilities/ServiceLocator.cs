...
public class ServiceLocator
{
    ...
    {
        public ServiceAlreadyRegisteredException(System.Type T) : base(
            "A service of that name (" + T.ToString() + ")  has already been registered!")
        {
        }
    }
    ...
    {
        public ServiceNotFoundException(System.Type T) : base(
            "Service (" + T.ToString() +
