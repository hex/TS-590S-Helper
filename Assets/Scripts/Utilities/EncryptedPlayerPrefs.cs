...
public class EncryptedPlayerPrefs  {
    ...
    private static string privateKey="23be46c849bfa16f8b1fae4e08df20b3";
    
    // Add some values to this array before using EncryptedPlayerPrefs
    public static string[] keys =
    {
        "ztYTFXpbdZCIaCYt1ns5AZBAKgpMR",
        "D5eGawV9omPaiSh0HtWWG8A5JYzz6Bu",
        "uu4ARZA9nLmEZBCZBvFqfWDm",
        "EACJW1Xw9bRlTlzeiAuWAmdoJckEAZD",
        "RqfWDmXD5DMnbvInxZC2sVVvBmuED"
    };
